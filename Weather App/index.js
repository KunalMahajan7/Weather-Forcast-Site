...
const API_KEY = "1cde4d88311b4ccf0a6eed18c2b0d12e";
...
function switchTab(ClickedTab) {
    ...
    if (!searchForm.classList.contains("active")) {
        ...
        // main phela search wala taab main tha ab your weather wale tab mai aa raha hu
...
function getlocation() {
    if (navigator.geolocation) {
        ...
        alert("NO GEO LOCATION AVALIABLE");
    }
}
